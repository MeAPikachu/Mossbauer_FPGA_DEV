...
HOSTNAME = 'zeldafitzgerald.exp.univie.ac.at'#'red-pitaya3.exp.univie.ac.at'
USERNAME = 'root'
PASSWORD = 'root'
NPLL = '2'
    ...
    def update_table_widget(self):
        ...
        for row, param in enumerate(self.rp.glob_parameter_keys):
            if 'output' in param:
                ...
                self.comboBox_output[param].currentTextChanged.connect(lambda val, param_=param: self.updateParam(param_, val, 0))
