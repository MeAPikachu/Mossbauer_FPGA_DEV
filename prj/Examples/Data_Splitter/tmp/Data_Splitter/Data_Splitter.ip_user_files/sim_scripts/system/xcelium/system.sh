...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Data_Splitter.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Data_Splitter.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
       +incdir+"../../../../Data_Splitter.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../Data_Splitter.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
       +incdir+"/tools/Xilinx/Vivado/2020.1/data/xilinx_vip/include"
}
