...
# module references:
# adc_smooth_mossbauer, trigger_mossbauer, bessel_filter, bessel_filter, bessel_filter, cycle_counter, cycle_counter, event_convert, event_count, trigger_mossbauer, high_threshold, low_threshold, rising32, signal_split, slow_clock_generator
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_DOUT_DEFAULT_2 {0x00000437} \
   CONFIG.C_IS_DUAL {1} \
 ] $axi_gpio_5
  ...
  # Create instance: bessel_filter_2, and set properties
  set block_name bessel_filter
  set block_cell_name bessel_filter_2
  if { [catch {set bessel_filter_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bessel_filter_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: cycle_counter_1, and set properties
  set block_name cycle_counter
  set block_cell_name cycle_counter_1
  if { [catch {set cycle_counter_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $cycle_counter_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: event_convert_0, and set properties
  set block_name event_convert
  set block_cell_name event_convert_0
  if { [catch {set event_convert_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $event_convert_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: event_count_0, and set properties
  set block_name event_count
  set block_cell_name event_count_0
  if { [catch {set event_count_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $event_count_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set block_name trigger_mossbauer
  set block_cell_name forward_skim
  if { [catch {set forward_skim [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $forward_skim eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: high_threshold, and set properties
  set high_threshold [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 high_threshold ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {29} \
   CONFIG.DIN_TO {16} \
   CONFIG.DOUT_WIDTH {14} \
  ...
  set low_threshold [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 low_threshold ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {13} \
   CONFIG.DOUT_WIDTH {14} \
 ] $low_threshold
  ...
  # Create instance: reset1, and set properties
  set reset1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 reset1 ]
  ...
  # Create instance: run_enable, and set properties
  set run_enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 run_enable ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  # Create instance: run_reset, and set properties
  set run_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 run_reset ]
  ...
  # Create instance: xlslice_CH2_14, and set properties
  set xlslice_CH2_14 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_CH2_14 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {13} \
   CONFIG.DOUT_WIDTH {14} \
 ] $xlslice_CH2_14
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
  ...
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins adc_smooth_mossbauer_0/adc_clk] [get_bd_pins axis_red_pitaya_adc_0/adc_clk] [get_bd_pins back_skim/clk] [get_bd_pins bessel_filter_0/clk] [get_bd_pins bessel_filter_1/clk] [get_bd_pins bessel_filter_2/clk] [get_bd_pins cycle_counter_0/clk] [get_bd_pins cycle_counter_1/clk] [get_bd_pins event_convert_0/adc_clk] [get_bd_pins event_count_0/clk] [get_bd_pins forward_skim/clk] [get_bd_pins high_threshold_0/adc_clk] [get_bd_pins low_threshold_0/adc_clk] [get_bd_pins rising32_0/adc_clk] [get_bd_pins slow_clock_generator_0/adc_clk]
  ...
  connect_bd_net -net bessel_filter_1_adc_filt_a [get_bd_pins bessel_filter_1/adc_filt_a] [get_bd_pins bessel_filter_2/adc_dat_a]
  connect_bd_net -net bessel_filter_2_adc_filt_a [get_bd_pins bessel_filter_2/adc_filt_a] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net c_ht_Dout [get_bd_pins c_ht/Dout] [get_bd_pins event_convert_0/high_threshold]
  connect_bd_net -net cycle_counter_0_for_count [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins cycle_counter_0/for_count]
  connect_bd_net -net cycle_counter_1_for_count [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins cycle_counter_1/for_count]
  ...
  connect_bd_net -net high_threshold_0_vlh [get_bd_pins back_skim/trigger] [get_bd_pins high_threshold_0/vlh] [get_bd_pins led_concat/In1]
  ...
  connect_bd_net -net low_threshold_0_vgl [get_bd_pins forward_skim/trigger] [get_bd_pins led_concat/In0] [get_bd_pins low_threshold_0/vgl]
  ...
  connect_bd_net -net reset1_dout [get_bd_pins bessel_filter_0/reset] [get_bd_pins bessel_filter_1/reset] [get_bd_pins bessel_filter_2/reset] [get_bd_pins reset1/dout]
  connect_bd_net -net reset_dout [get_bd_pins high_threshold_0/rst] [get_bd_pins low_threshold_0/rst] [get_bd_pins reset/dout] [get_bd_pins rising32_0/rst]
  connect_bd_net -net rising32_0_falling [get_bd_pins back_skim/mask] [get_bd_pins led_concat/In3] [get_bd_pins rising32_0/falling] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net rising32_0_rising [get_bd_pins forward_skim/mask] [get_bd_pins led_concat/In2] [get_bd_pins rising32_0/rising] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net run_enable_Dout [get_bd_pins cycle_counter_0/r_enable] [get_bd_pins cycle_counter_1/r_enable] [get_bd_pins event_count_0/run_enable] [get_bd_pins led_concat/In7] [get_bd_pins run_enable/Dout]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins led_concat/In4] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins bessel_filter_0/adc_dat_a] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_CH1_Dout [get_bd_pins data_concat/In0] [get_bd_pins xlslice_CH1/Dout]
  connect_bd_net -net xlslice_CH2_14_Dout [get_bd_pins event_convert_0/adc_dat_b] [get_bd_pins xlslice_CH2_14/Dout]
  connect_bd_net -net xlslice_CH2_Dout [get_bd_pins data_concat/In1] [get_bd_pins xlslice_CH2/Dout]

  # Create address segments
  assign_bd_address -offset 0x42000000 -range 0x00000400 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x42100000 -range 0x00000400 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x42200000 -range 0x00000400 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x42300000 -range 0x00000400 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] -force
  assign_bd_address -offset 0x42400000 -range 0x00000400 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_4/S_AXI/Reg] -force
  assign_bd_address -offset 0x42500000 -range 0x00000400 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_5/S_AXI/Reg] -force
