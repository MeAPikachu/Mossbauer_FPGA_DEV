...
set_property -dict [list CONFIG.DIN_TO {24} CONFIG.DIN_FROM {31} CONFIG.DIN_WIDTH {32} CONFIG.DOUT_WIDTH {8}] [get_bd_cells xls_LEDs]
endgroup
...
set_property -dict [list CONFIG.DIN_TO {0} CONFIG.DIN_FROM {0} CONFIG.DIN_WIDTH {32} CONFIG.DOUT_WIDTH {1}] [get_bd_cells xls_CE]
endgroup

# slice SCLR
startgroup
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xls_SCLR
set_property -dict [list CONFIG.DIN_TO {1} CONFIG.DIN_FROM {1} CONFIG.DIN_WIDTH {32} CONFIG.DOUT_WIDTH {1}] [get_bd_cells xls_SCLR]
endgroup
...
# LED Real Output
startgroup 
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xls_real
set_property -dict [list CONFIG.DIN_TO {0} CONFIG.DIN_FROM {7} CONFIG.DIN_WIDTH {32} CONFIG.DOUT_WIDTH {8}] [get_bd_cells xls_real]
endgroup 

connect_bd_net [get_bd_ports led_o] [get_bd_pins xls_LEDs/Dout]
delete_bd_objs [get_bd_nets xls_LEDs_Dout]
connect_bd_net [get_bd_pins xls_real/Din] [get_bd_pins axi_gpio_0/gpio_io_o]
connect_bd_net [get_bd_pins xls_real/Dout] [get_bd_ports led_o]
